...
It is possible to build a web screenshot service using PhantomJS. There are [Related Projects]({{ site.url }}/related-projects.html) which make it easy to create such a service.
