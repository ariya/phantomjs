...
JSErrorCallback::JSErrorCallback(JSObject* callback, JSDOMGlobalObject* globalObject)
...
bool JSErrorCallback::handleEvent(FileError* error)
{
    if (!canInvokeCallback())
        return true;

    RefPtr<JSErrorCallback> protect(this);
